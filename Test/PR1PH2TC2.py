...
# but one of the order is not placed due to insufficient BALANCE
...
def t2(result):  # Second concurrent request
    ...
    # Customer 302 requests an order of item 2, quantity 10 from restaurant 101
    http_response = requests.post(
        "http://localhost:8081/requestOrder", json={"custId": 302, "restId": 101, "itemId": 2, "qty": 10})
